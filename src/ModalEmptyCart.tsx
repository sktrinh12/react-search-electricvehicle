...
interface ModalEmptyProps {
  ...
  calculateTotal: (cart: CartItem[]) => void;
}
...
const ModalEmptyCart = ({
  ...
  const handleConfirmEmptyCart = () => {
    localStorage.setItem("cart", JSON.stringify([])); // Convert array to JSON string
    setCart([]);
    calculateTotal([]);
    setModalOpen(false);
  };
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", mt: 3 }}>
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  borderColor: BACKGROUND_COLOUR,
                  backgroundColor: adjustBrightness(SELECT_COLOUR2, 20),
                },
              }}
            >
              Yes
            ...
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  borderColor: COLOUR,
                  backgroundColor: adjustBrightness(COLOUR, 20),
                },
              }}
            >
              No
